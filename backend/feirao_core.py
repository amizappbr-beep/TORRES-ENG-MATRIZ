...
DEFAULT_CONFIG: Dict[str, Any] = {
    "_id": "feirao",
    "event": {
        "nome": "Feirão do Imóvel Torres Engenharia",
        "data": "2026-09-19",
        "data_label": "19 de setembro de 2026",
        "local_nome": "Residencial Reserva (Reserva 025)",
    ...
    "empreendimentos": {
        "viva": {
            ...
            "preco_label": "A DEFINIR / CONFIGURÁVEL NO ADMIN",
            "entrada_label": "A DEFINIR / CONFIGURÁVEL NO ADMIN",
        },
        "alameda": {
            "slug": "alameda",
            "nome": "Alameda",
